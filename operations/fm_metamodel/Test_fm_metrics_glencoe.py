...
from famapy.metamodels.fm_metamodel.transformations import GlencoeReader

from models.models_info import *


def get_model(model_name) -> FeatureModel:
    return GlencoeReader(INPUT_GLENCOE_MODELS_FOLDER + model_name + GLENCOE_EXTENSION).transform()
