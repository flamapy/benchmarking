...
from pysat_metamodel.famapy.metamodels.pysat_metamodel.operations.glucose3_error_detection import Glucose3ErrorDetection
...
class ErrorDetectionTest(TestCase):
    ...
    def testCase15(self):
        ...
        pysat_model = self.setUp("models/fama_test_suite/error-guessing/redundancies/case1/r-case1.fama")
        expected_output = ["Redundancies: ['B requires C']"]
        self.ErrorDetectionOperation(pysat_model, expected_output)

    def testCase16(self):
        print("----------Error Detection Test Case 16----------")
        pysat_model = self.setUp("models/fama_test_suite/error-guessing/redundancies/case2/r-case2.fama")
